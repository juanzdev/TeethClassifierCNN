...
def parse_log(log_file):
    ...
    #print(log)
    #I0228 05:55:10.597868 2110844928 solver.cpp:219] Iteration 2880 (0.385594 iter/s, 25.934s/10 iters), loss = 0.678826
    #I0228 06:00:21.990275 2110844928 solver.cpp:311] Iteration 3000, loss = 0.677754
    #loss_pattern = r"Iteration (?P<iter_num>\d+), loss = (?P<loss_val>[+-]?(\d+(\.\d*)?|\.\d+)([eE][+-]?\d+)?)"
    loss_pattern = r"Iteration (?P<iter_num>\d+) (?P<itersec>.*), loss = (?P<loss_val>[+-]?(\d+(\.\d*)?|\.\d+)([eE][+-]?\d+)?)"
    losses = []
    loss_iterations = []
